...
<section class="relative z-[1] min-h-screen flex flex-col items-center justify-center text-center px-8 max-sm:px-5 pt-20 pb-16 overflow-hidden">
	<LiveBattle />
	
	<h1
		class="relative z-[2] font-game text-[clamp(2.5rem,8vw,6rem)] leading-[1.05] text-star-white tracking-[0.04em] mb-6"
		style="text-shadow: 0 0 40px rgba(56,189,248,0.6), 0 0 80px rgba(36,89,184,0.3)"
	>
		ASTROSWARM
	</h1>

	<p class="relative z-[2] font-game text-[clamp(0.5rem,1.4vw,0.75rem)] text-text-muted tracking-[0.18em] mb-10 max-w-[520px] leading-loose max-sm:text-[0.65rem] max-sm:tracking-[0.12em]">
		DESIGN SPECIES. PROGRAM BEHAVIOR. UNLEASH YOUR SWARM.
	</p>
